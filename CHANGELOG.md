...
### Changed
- Follow-up release to test npm trusted publisher settings from GitHub Actions.

## [0.2.3] - 2026-03-12

### Changed
- Follow-up release to validate the corrected publish-step selection logic in GitHub Actions.

## [0.2.2] - 2026-03-12

### Changed
- Follow-up release to validate the corrected tag-triggered publish workflow and GitHub Release flow.
